...
def upate_uncertain_count(sender, instance, **kwargs):
    ...
    if instance.uncertain_count == 5:
        ...
        instance.set_exit_classification_bias(
            instance.bias, instance.MALICIOUS)
        instance.set_exit_round(
            instance.task_assignments.exclude(user_answer=None).exclude(bias_at_answer=0.0).count())
        return
    ...
    #         print 'catch random'
    #         instance.set_exit_classification_bias(
    #             instance.bias, instance.RANDOM)
    #         instance.set_exit_round(
    #             instance.task_assignments.exclude(
    #                 user_answer=None).exclude(bias_at_answer=0.0).count())
    #     return
